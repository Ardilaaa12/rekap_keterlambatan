...
@section('content')
    ...
    <div class="jumbotron py-4 px-5">
        ...
        <div class="content-card d-flex">
            <div class="card m-2 p-2 p-2" style="width: 50%;">
                <div class="card-body">
                    ...
                    <h4 style="margin: -35px 0 0 80px;">{{ DB::table('students')->count() }}</h4>
                </div>
            </div>
            <div class="card m-2 p-2" style="width: 25%;">
                <div class="card-body">
                    ...
                    <h4 style="margin: -35px 0 0 80px;">{{ DB::table('users')->where('role', 'admin')->count()  }}</h4>
                </div>
            </div>
            <div class="card m-2 p-2" style="width: 25%;">
                <div class="card-body">
                    ...
                    <h4 style="margin: -35px 0 0 80px;">{{ DB::table('users')->where('role', 'ps')->count()  }}</h4>
                </div>
            </div>
        </div>
        <div class="content-card d-flex">
            <div class="card m-2 p-2" style="width: 50%;">
                <div class="card-body">
                    ...
                    <h4 style="margin: -35px 0 0 80px;">{{ DB::table('rombels')->count() }}</h4>
                </div>
            </div>
            <div class="card m-2 p-2" style="width: 50%;">
                <div class="card-body">
                    ...
                    <h4 style="margin: -35px 0 0 80px;">{{ DB::table('rayons')->count() }}</h4>
                </div>
            </div>
