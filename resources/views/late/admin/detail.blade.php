...
@section('content')
    <a href="{{ route('late.file') }}" class="btn btn-primary float-sm-end m-2">Kembali</a>
    <h1>Detail Data Keterlambatan</h1>
    <div class="tags">
        <h5 style="color: black;">
            <a class="button_waterpump" style="color: rgb(101, 100, 100);" href="/dashboard">Home</a> /
            <a class="button_waterpump" style="color: rgb(101, 100, 100);" href="{{ route('late.file')}}">Data Keterlambatan</a> /
