...
@section('content')
    ...
    <div class="tab">
        <div class="p-4">
            <a href="{{ route('late.excel-export')}}" class="btn btn-info float-sm-end m-2">Export Data Keterlambatan</a>
        </div>
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('late.data')}}">Keseluruhan Data</a>
            </li>
            <li class="nav-item">
            ...
            <tbody>
                ...
                @foreach ($lates as $item)
                    <tr>
                        ...
                        <td><a href="{{ route('late.show', ['id' => $item->student_id]) }}">lihat</a></td>
                        ...
                        <td class="d-flex">
                            <a href="{{ route('late.cetak', ['id' => $item->student_id]) }}" class="btn btn-danger">Cetak Surat Pernyataan</a>
                        </td>
                        @endif
                    </tr>
                @endforeach
